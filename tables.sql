...
CREATE TABLE TBL_STREETEVENT (
    SENO        INT(11) NOT NULL,
    SEPLAYER    VARCHAR(30)        COMMENT '참가자',
    SEPLACE     VARCHAR(100)       COMMENT '위치',
    SETYPE      VARCHAR(20)        COMMENT '종류',
    SEDATE      CHAR(10)           COMMENT '행사일자',
    SETIME      VARCHAR(15)        COMMENT '행사시간',
    SELAT       FLOAT(10,7)        COMMENT '위도',        
    SELON       FLOAT(10,7)        COMMENT '경도',
    SEADDR      VARCHAR(100)       COMMENT '주소'
);
...
CREATE TABLE TBL_COURSEREPLY (
  RENO       INT(11) NOT NULL AUTO_INCREMENT COMMENT '댓글 번호',
  CMNO       INT(11) NOT NULL                COMMENT '게시물 번호',
  USERNO     INT(11)                         COMMENT '작성자',
  REMEMO     VARCHAR(500)                    COMMENT '댓글내용',
  REDATE     DATETIME                        COMMENT '작성일자',
  REDELETEFLAG CHAR(1)                       COMMENT '삭제여부',
...
INSERT INTO COM_CODE(CLASSNO, CODECD, CODENM) VALUES('e', 'E', 'settings_input');
...
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('t', 'E',  '기타');
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('t', 'F1', '계류');
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('t', 'F2', '물놀이장');
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('t', 'F3', '바닥분수');
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('t', 'F4', '벽천');
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('t', 'F5', '생태연못');
...
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('sns', 'g', 'Google');
INSERT INTO COM_CODE (CLASSNO, codecd, codenm) value('sns', 'f', 'Facebook');
