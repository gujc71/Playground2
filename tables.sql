...
INSERT INTO `TBL_PLAYGROUND` (`PGNO`, `PGNAME`, `PGLAT`, `PGLON`, `PGURL`, `PGTEL`, `PGADDR`, `PGTYPE1`, `PGTYPE2`, `PGSIZE`, `PGPRICE`, `PGDESC`, `PGEXTRA1`, `PGEXTRA2`, `PGEXTRA3`, `UPDATEDATE`, `DELETEFLAG`) VALUES
	...
	('C000000516', '서울상상나라', 127.0774994, 37.5508881, 'http://www.seoulchildrensmuseum.org', '02-6450-9500', '서울특별시 광진구 능동로 216', 'C', '공립', 0, '어른관람료: 4000\r\n청소년관람료: 4000\r\n어린이관람료: 4000\r\n관람료기타정보: ', '', '평일관람시간시간: 00:00 - 00:00\r\n공휴일관람시간: 00:00 - 00:00\r\n휴관정보: 홈페이지참고', '', '', '2019-05-12 23:43:25', 'N'),
	('C000000935', '아리수나라', 127.0776978, 37.5513039, 'http://arisumuseum.seoul.go.kr/arisunara/content/sub1_1.jsp', '', '서울특별시 광진구 능동로 216', 'C', '공립', 0, '무료', '만6세~만10세(초등학교 4학년) 어린이를 대상으로 다양한 놀이와 체험을 통해 물과 환경의 중요성을 일깨우고, 서울 수돗물 “아리수”의 안전성과 우수성에 대한 정확한 이해를 돕기 위해 전국 최초로 어린이 수돗물체험 홍보관 “아리수나라”를 서울어린이대공원내에 개관(’10.10.26’)하였습니다.', '', '', '', NULL, 'N'),
	...
	('D000000011', '서울특별시교육청노원평생학습관', 127.0676346, 37.6393242, 'HTTP://nwllc.sen.go.kr', '02-979-1741', '서울특별시 노원구 동일로204길 13', 'D', '공공', NULL, NULL, NULL, '\n매월 둘째, 넷째주 월요일', NULL, NULL, '2019-05-18 16:43:10', 'N'),
	...
	('C000000934', '서울시립 북서울미술관', 127.0668640, 37.6406631, 'http://sema.seoul.go.kr/it/artinfo/northart/getIntro', '02 )2124-5248', '서울 노원구 동일로 1238', 'C', '공립', 0, '무료', '‘갈대언덕’에서 연유한 노원이라는 지명을 살려 공원 속 작은 동산 위에 세워진 북서울미술관은 공원을 산책하며 자연스럽게 미술관과 가까워질 수 있도록 산책로와 미술관 출입구를 연결한 개방형 미술관입니다. \r\n\r\n시민들의 일상 속에 문화의 향기가 배어들 수 있도록 모두가 보고, 느끼고, 체험하고, 즐기며, 함께 할 수 있는 지역문화의 거점이 되겠습니다.', '관람시간\r\n평일(화-금) 10AM~8PM\r\n토·일·공휴일\r\n하절기 (3-10월)\r\n10 AM~ 7 PM\r\n동절기 (11-2월)\r\n10AM~ 6PM\r\n\r\n휴관일\r\n매주 월요일\r\n정기휴관 (1월1일)\r\n', '', '', '2019-05-14 19:34:17', 'N'),
	('C000000919', '노원우주학교	', 127.0652161, 37.6407471, 'https://nowoncosmos.or.kr/', '02-971-6232', '서울특별시 노원구 동일로 205길 13', 'C', '공립', 0, '소인(개인:1,000원/단체:1,000원) / 대인(개인:2,000원/단체:2,000원)', '우주와 생명과 인간,\r\n그 탄생과 진화의\r\n경이로운 시간과 함께 걷다\r\n\r\n우주의 여정\r\n\r\n이 세상 모든 것이 어떻게 해서 오늘날과 같이 되었으며 우리는 어디에 위치해 있고, 이 모든 것들은 어떻게 될 것인가?\r\n우주, 지구, 생명, 인류의 진화에 대한 모든 것, 우주학교의 전시물로 만나보세요 ', '일반관람 (09:30~17:30) 야간관측 (평일없음 19:30~21:00)', '', '', '2019-05-14 19:28:10', 'N'),
	('C000000936', '한양도성박물관', 127.0085907, 37.5730019, 'http://www.museum.seoul.kr/scwm/NR_index.do', '', '서울특별시 종로구 율곡로283', 'C', '공립', 0, '', '\r\n\r\n    지형과 한 몸이 되어 축조된 한양도성은 근대화 과정에서 일부 훼철되기도 하였지만, 오늘날까지 그 원형이 잘 남아 있어 도시와 공존하는 문화유산입니다.\r\n\r\n    동대문성곽공원에 위치한 한양도성박물관은 조선시대부터 현재에 이르기까지 한양도성의 역사와 문화를 담은 박물관으 로 상설전시실, 기획전시실, 도성정보센터와 학습실을 갖춘 문화공간입니다. 한양도성박물관에서 600년 한양도성의 역사 와 문화유산으로서의 미래가치를 확인하시기 바랍니다.\r\n', '', '', '', NULL, 'N'),
	...
	('C000000937', '불암산 나비정원', 127.0806351, 37.6554794, 'https://www.facebook.com/BuramsanButterflyGarden/', '02-936-0900', '노원구 한글비석로12길 51-27', 'C', '공립', 0, '', '', '영업종료 10:00~17:00 - 입장마감 16:30 , 휴무 월요일', '', '', NULL, 'N'),
	('D000000036', '노원어린이도서관', 127.0766296, 37.6581726, 'https://www.nowonlib.kr/local/html/childrenLocation', '02-933-7145', '서울특별시 노원구 한글비석로 346', 'D', '공공', 0, '', '', '매주 화요일 및 법정 공휴일', '', '', '2019-05-18 16:43:10', 'N'),
	...
	('D000000009', '서울특별시교육청동대문도서관', 127.0248566, 37.5734749, 'http://ddmlib.sen.go.kr/ddmlib_index.jsp', '02-2170-1000', '서울특별시 동대문구 천호대로4길 22', 'D', '공공', NULL, NULL, NULL, '\n매월 둘째, 넷째 수요일 및 일요일을 제외한 공휴일', NULL, NULL, '2019-05-18 16:43:10', 'N'),
	('D000001390', '아름꿈도서관(종로문화재단)', 127.0171204, 37.5727119, 'https://www.jfac.or.kr/site/main/content/arum_dream03', '02-2237-6644~5', '서울특별시 종로구 종로58가길 19', 'D', '공공', 0, '', '', '매주 일요일, 1월 1일, 설연휴, 추석연휴', '', '', '2019-05-18 16:43:10', 'N');
